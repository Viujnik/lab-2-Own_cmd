...
# Здесь собраны функции, необходимые основной функции - clear, чтобы не загрязнять и так грязный main


def get_environment_type():
    """Определяет тип запуска (терминал или IDE)"""
...
def clear_realisation():
    """
    Очистка экрана с определением типа окружения
    """
    try:
